...
const PERFORMERS: Perf[] = [
    ...
    { id: "p3", name: "Abella", count: 8 },
    { id: "p4", name: "Mia", count: 7 },
    { id: "p5", name: "Riley", count: 6 },
    { id: "p6", name: "Faye", count: 5 },
    { id: "p7", name: "Adriana", count: 4 },
    { id: "p8", name: "Emily", count: 3 },
    { id: "p9", name: "Gabbie", count: 2 },
    { id: "p10", name: "Hazel", count: 1 },
    { id: "p11", name: "Melody", count: 7 },
    { id: "p12", name: "Lana", count: 6 },
    { id: "p13", name: "August", count: 5 },
    { id: "p14", name: "Zoey", count: 5 },
    { id: "p15", name: "Elsa", count: 4 },
    { id: "p16", name: "Angel", count: 4 },
    { id: "p17", name: "Bella", count: 3 },
    { id: "p18", name: "Violet", count: 3 },
    { id: "p19", name: "Janice", count: 2 },
    { id: "p20", name: "Stacy", count: 2 },
];
